...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   button2.position(556,100);
   button2.size(50,50);
   button2.mouseClicked(drop2);

   airblower = createImg('baloon2.png');
   airblower.position(350,304);
   airblower.size(120,120);
   airblower.mouseClicked(blow);
 
   rope = new Rope(7,{x:200,y:90});
   rope2 = new Rope(7,{x:590,y:90});

star=createSprite(400,60,20,20)
star.addImage(starimage)
star.scale=0.02

star2=createSprite(76,340,20,20)
star2.addImage(starimage)
star2.scale=0.02
starcounter=createSprite(50,20,30,30)
starcounter.scale=0.2
starcounter.addAnimation("empty",empty_star)
starcounter.addAnimation("one",one_star)
starcounter.addAnimation("two",two_star)
...
function draw() 
{
  ...
  {
    star2.visible=false
    starcounter.changeAnimation("two")
  }
